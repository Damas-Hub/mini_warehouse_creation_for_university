...
export default function Component() {
  ...
  useEffect(() => {
    toast({
      title: "Welcome to University Data Warehouse! 🎓",
      description: "Dashboard loaded successfully. You can now add students and enrollments.",
    })
  }, [toast])
  ...
  const semesterTrends = [
    { semester: "First Semester 2022", enrollments: 245, avgGrade: 82.1, passRate: 89 },
    { semester: "Second Semester 2022", enrollments: 268, avgGrade: 83.5, passRate: 91 },
    { semester: "First Semester 2023", enrollments: 285, avgGrade: 84.2, passRate: 92 },
    { semester: "Second Semester 2023", enrollments: 302, avgGrade: 85.1, passRate: 93 },
  ]
  ...
  const handleStudentSubmit = (e: React.FormEvent) => {
    ...
    if (!studentFormData.name || !studentFormData.email || !studentFormData.classLevel || !studentFormData.department) {
      toast({
    ...
    const newStudent = {
      ...
      classLevel: studentFormData.classLevel,
      gpa: 0.0,
      totalCredits: 0,
      department: studentFormData.department,
      enrollmentDate: studentFormData.enrollmentDate || new Date().toISOString().split("T")[0],
      retentionRate: 85,
      avgGrade: 0,
    }
    ...
    toast({
      ...
      description: `${newStudent.name} has been added to the ${newStudent.department} department.`,
    })
  }
  ...
  const handleEnrollmentSubmit = (e: React.FormEvent) => {
    ...
    if (!enrollmentFormData.studentId || !enrollmentFormData.courseCode || !enrollmentFormData.semester) {
      toast({
        title: "Validation Error",
        description: "Please fill in all required fields marked with *",
        variant: "destructive",
    ...
    const student = students.find(s => s.id === parseInt(enrollmentFormData.studentId))
    const course = courses.find(c => c.code === enrollmentFormData.courseCode)

    if (!student || !course) {
      toast({
        title: "Invalid Selection",
        description: "Please select a valid student and course",
        variant: "destructive",
      })
      return
    }
    ...
    const newEnrollment = {
      ...
      studentId: parseInt(enrollmentFormData.studentId),
      studentName: student.name,
      courseCode: enrollmentFormData.courseCode,
      courseName: course.name,
      semester: enrollmentFormData.semester,
      grade: enrollmentFormData.grade,
      letterGrade: enrollmentFormData.letterGrade,
    ...
    toast({
      ...
      description: `${student.name} has been enrolled in ${course.code} - ${course.name} for ${enrollmentFormData.semester}.`,
    })
  }
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">University Data Warehouse Dashboard</h1>
          ...
          <div className="flex space-x-2">
            ...
            <Button onClick={() => setShowEnrollmentModal(true)} variant="outline">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Select value={selectedSemester} onValueChange={setSelectedSemester}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="First Semester 2023">First Semester 2023</SelectItem>
                  <SelectItem value="Second Semester 2023">Second Semester 2023</SelectItem>
                </SelectContent>
              </Select>
              ...
              <div className="overflow-y-auto max-h-[calc(90vh-120px)]">
                <form onSubmit={handleStudentSubmit} className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={studentFormData.classLevel} onValueChange={(value) => setStudentFormData({...studentFormData, classLevel: value})}>
                      <SelectTrigger>
                        <SelectValue placeholder="Select class level" />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div>
                    ...
                    <Select value={studentFormData.department} onValueChange={(value) => setStudentFormData({...studentFormData, department: value})}>
                      <SelectTrigger>
                        <SelectValue placeholder="Select department" />
                      </SelectTrigger>
                      <SelectContent>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg w-full max-w-md max-h-[90vh] overflow-hidden">
              <div className="flex justify-between items-center p-6 border-b">
                ...
                <Button variant="ghost" size="sm" onClick={() => setShowEnrollmentModal(false)}>
                  <X className="w-4 h-4" />
                </Button>
              </div>
              <div className="overflow-y-auto max-h-[calc(90vh-120px)]">
                <form onSubmit={handleEnrollmentSubmit} className="p-6 space-y-4">
                  <div>
                    ...
                    <Select value={enrollmentFormData.studentId} onValueChange={(value) => setEnrollmentFormData({...enrollmentFormData, studentId: value})}>
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select value={enrollmentFormData.courseCode} onValueChange={(value) => setEnrollmentFormData({...enrollmentFormData, courseCode: value})}>
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select value={enrollmentFormData.semester} onValueChange={(value) => setEnrollmentFormData({...enrollmentFormData, semester: value})}>
                      <SelectTrigger>
                        <SelectValue placeholder="Select semester" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="First Semester 2023">First Semester 2023</SelectItem>
                        <SelectItem value="Second Semester 2023">Second Semester 2023</SelectItem>
                        <SelectItem value="First Semester 2024">First Semester 2024</SelectItem>
                        <SelectItem value="Second Semester 2024">Second Semester 2024</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setEnrollmentFormData({...enrollmentFormData, grade: parseFloat(e.target.value)})}
                      min="0"
                      max="100"
                      step="0.1"
                    />
                  ...
                  <div>
                    ...
                    <Select value={enrollmentFormData.letterGrade} onValueChange={(value) => setEnrollmentFormData({...enrollmentFormData, letterGrade: value})}>
                      <SelectTrigger>
                  ...
                  <div className="flex space-x-2 pt-4">
                    ...
                    <Button type="button" variant="outline" onClick={() => setShowEnrollmentModal(false)}>Cancel</Button>
                  </div>
                </form>
              </div>
            </div>
